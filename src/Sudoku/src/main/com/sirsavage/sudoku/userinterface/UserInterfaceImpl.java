...
public class UserInterfaceImpl implements IUserInterfaceContract.View,
    ...
    see java.lang.object in the documentation) of each TextField by their Coordinates. 
    When a SudokuGame is given to the updateUI method, we iterate through it by X and Y coordinates and assign the values to the
    ...
    */
    ...
    /**
     * Stage and Group are JavaFX specific classes for modifying the UI. Think of them as containers of various UI components.
     */
    ...
    private void drawTextFields(Group root) {
        ...
        for (int xIndex = 0; xIndex < 9; xIndex++) {
            for (int yIndex = 0; yIndex < 9; yIndex++) {
                ...
                //By passing "this" (which means the current instance of UserInterfaceImpl), when an action occurs, it will jump straight to "handle(ActionEvent actionEvent)" down below.
